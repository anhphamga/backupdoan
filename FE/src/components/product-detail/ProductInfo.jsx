  ...
  return (
    <section className="space-y-5 rounded-3xl border border-neutral-200 bg-white p-5 shadow-sm lg:p-6">
      <div className="space-y-4">
        <p className="break-words text-[11px] font-semibold uppercase tracking-[0.24em] text-neutral-500">{category || "Danh mục"}</p>
      ...
      <div className="grid gap-3 rounded-3xl border border-amber-200 bg-[linear-gradient(135deg,#fff7e6_0%,#fff4d6_100%)] p-4 sm:grid-cols-2 lg:p-5">
        <div className="min-w-0 rounded-2xl bg-white/40 p-3">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-neutral-500">Giá thuê</p>
          <p className="mt-2 whitespace-nowrap text-3xl font-bold text-amber-700">{rentPriceText}</p>
          <p className="mt-1 text-xs text-neutral-500">/ngày</p>
        </div>
        <div className="min-w-0 rounded-2xl bg-white/40 p-3">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-neutral-500">Giá bán</p>
          <p className="mt-2 whitespace-nowrap text-2xl font-semibold text-neutral-800">{salePriceText}</p>
        </div>
      </div>
