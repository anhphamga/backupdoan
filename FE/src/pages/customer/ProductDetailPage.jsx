    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fcfaf7_0%,#f7f4ee_24%,#f5f5f4_100%)] pb-24 md:pb-10">
      ...
      <main className="w-full px-3 py-3 md:px-4 md:py-4">
        <div className="mx-auto w-full max-w-[1320px]">
          ...
          <Link
            className="mb-4 inline-flex min-h-10 items-center rounded-full border border-neutral-200 bg-white px-3 py-1.5 text-sm font-semibold text-neutral-700 shadow-sm hover:bg-neutral-50"
            to="/buy"
          >
            {"<"} {t.back}
          </Link>
          ...
          {!loading && product && (
            <>
              <section className="grid items-start gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.8fr)] xl:gap-6">
                <ProductGallery
              ...
              <section className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.8fr)] xl:gap-6">
                <ProductDescription description={product.description} />

                <div className="w-full">
                  <div className="rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm">
                    <h3 className="text-lg font-semibold text-neutral-900">{t.policyTitle}</h3>
                    <ul className="mt-2.5 space-y-2 text-sm text-neutral-700">
                      <li className="rounded-2xl bg-neutral-50 px-3 py-2.5">{t.policyDeposit}</li>
                      <li className="rounded-2xl bg-neutral-50 px-3 py-2.5">{t.policySwap}</li>
                      <li className="rounded-2xl bg-neutral-50 px-3 py-2.5">{t.policyTime}</li>
                    </ul>
                  </div>
                </div>
              </section>
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-4 shadow-xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-2.5 py-1.5 focus:border-pink-500 focus:outline-none focus:ring-1 focus:ring-pink-500"
                />
              </div>
              ...
              {rentStartDate && rentEndDate && (
                <div className="rounded-lg bg-pink-50 px-3 py-2.5 text-sm">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-lg bg-pink-600 px-3 py-1.5 font-medium text-white hover:bg-pink-700 disabled:bg-pink-300"
              >
